...
import 'mood_changes_model.dart';
export 'mood_changes_model.dart';

class MoodChangesWidget extends StatefulWidget {
  const MoodChangesWidget({super.key});

  @override
  State<MoodChangesWidget> createState() => _MoodChangesWidgetState();
}

class _MoodChangesWidgetState extends State<MoodChangesWidget> {
  late MoodChangesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MoodChangesModel());
  }
